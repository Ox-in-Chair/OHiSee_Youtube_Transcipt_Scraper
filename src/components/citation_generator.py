...
class CitationPanel(tk.Frame):
    ...
    def _build_ui(self):
        ...
        # Header
        tk.Label(
            self, text="Citation Generator", font=FONTS["h3"], bg="white", fg=COLORS["text"]
        ).pack(pady=SPACING["sm"], anchor="w", padx=SPACING["md"])
        ...
        tk.Label(
            format_frame, text="Format:", font=FONTS["body"], bg="white", fg=COLORS["text"]
        ...
        self.citation_text.pack(fill="both", expand=True, padx=SPACING["md"], pady=SPACING["sm"])
