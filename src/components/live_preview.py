...
class LivePreview(ttk.Frame):
    ...
    def _build_ui(self):
        ...
        summary_frame = tk.LabelFrame(
            self, text="Summary", font=FONTS["body"], bg="white", fg=COLORS["text"]
        )
        ...
        config_frame = tk.LabelFrame(
            self, text="Configuration (YAML)", font=FONTS["body"], bg="white", fg=COLORS["text"]
        )
        config_frame.pack(fill="both", expand=True, padx=SPACING["sm"], pady=SPACING["xs"])
        ...
        self.yaml_text.pack(fill="both", expand=True, padx=SPACING["xs"], pady=SPACING["xs"])
    ...
    def export_config(self):
        ...
        filename = filedialog.asksaveasfilename(
            defaultextension=".yaml", filetypes=[("YAML files", "*.yaml"), ("All files", "*.*")]
        )
        if filename:
