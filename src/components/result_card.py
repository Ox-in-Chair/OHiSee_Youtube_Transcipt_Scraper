...
class ResultCard(tk.Frame):
    ...
    def __init__(self, parent, result_data: Dict[str, Any], on_click: Optional[Callable] = None):
        super().__init__(
            parent,
            bg="white",
            width=280,
    ...
    def _build_ui(self):
        ...
        duration_badge = tk.Label(
            thumb_frame, text=duration, font=FONTS["small"], bg="black", fg="white", padx=4, pady=2
        )
...
class ResultCardGrid(ttk.Frame):
    ...
    def add_results(self, results: List[Dict[str, Any]]):
        ...
        for i, result in enumerate(results):
            ...
            card.grid(row=row, column=col, padx=SPACING["sm"], pady=SPACING["sm"], sticky="n")
